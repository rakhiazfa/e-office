<x-auth title="E Office | Tambah Jabatan">
    <!-- Page Title -->
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Tambah Data Jabatan</h4>
            </div>
        </div>
    </div>
    <!-- /Page Title -->
                ...
                <div class="card-body">
                    <form action="{{ route('jobs.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <select type="text" class="field" name="job_id" disabled>
                                </select>
                            </div>
                            <div class="col-12 mb-3">
                                <input type="text" class="field" name="name" placeholder="Masukan nama jabatan">
                                @error('name')
                                    <p class="invalid">{{ $message }}</p>
                                @enderror
                            </div>
